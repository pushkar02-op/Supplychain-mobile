...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['mart_id'], ['mart.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('item_id', 'order_date', 'mart_id', name='uq_order_unique_combination')
    )
    ...
    sa.ForeignKeyConstraint(['mart_id'], ['mart.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('batch_id', 'dispatch_date', 'mart_id', name='uq_dispatch_entry')
    )
