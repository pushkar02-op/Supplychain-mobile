...
Revision ID: c31cfd483d56
Revises:
Create Date: 2025-07-17 01:02:42.999211
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_mart_id"), "mart", ["id"], unique=False)
    op.create_table(
        "user",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_item_conversion_map_id"), "item_conversion_map", ["id"], unique=False
    )
    op.create_table(
        "order",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_dispatch_entry_id"), "dispatch_entry", ["id"], unique=False
    )
    op.create_table(
        "inventory_txn",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_rejection_entries_id"), "rejection_entries", ["id"], unique=False
    )
    op.create_table(
        "stockentry",
        sa.Column("id", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table("user")
    op.drop_index(op.f("ix_mart_id"), table_name="mart")
    op.drop_table("mart")
