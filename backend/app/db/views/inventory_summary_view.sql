CREATE OR REPLACE VIEW inventory_summary AS
  SELECT iv.warehouse_id, iv.item_id,i.name,uom.code  unit, SUM(CASE WHEN iv.txn_type = 'IN' THEN iv.base_qty
...
GROUP BY iv.warehouse_id, iv.item_id, i.name, uom.code;
