...
class InventoryFlowDaily(Base):
    ...
    in_qty = Column(Numeric(10, 3), default=0.0, nullable=False)
    out_qty = Column(Numeric(10, 3), default=0.0, nullable=False)
    net_qty = Column(Numeric(10, 3), default=0.0, nullable=False)
